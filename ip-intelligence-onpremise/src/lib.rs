...
//! [![51Degrees](https://51degrees.com/img/logo.png?utm_source=docs.rs&utm_medium=docs&utm_campaign=rust&utm_content=fiftyone-ip-intelligence-onpremise-lib.rs&utm_term=logo "Data rewards the curious")](https://51degrees.com/?utm_source=docs.rs&utm_medium=docs&utm_campaign=rust&utm_content=fiftyone-ip-intelligence-onpremise-lib.rs&utm_term=logo)
//!
...
//!     // RegisteredCountry is a plain string property, read through its accessor.
//!     if let Ok(country) = ip.registered_country().value() {
//!         println!("registered country = {country}");
//!     }
//! }
//! # Ok(())
//! # }
