...
//!   set at all (for example, it is excluded by the licence, the data file or
...
pub enum MissingPropertyReason {
    ...
    /// because the licence and/or data file does not include it.
    ...
    pub fn description(&self) -> &'static str {
        match self {
            MissingPropertyReason::DataFileUpgradeRequired => {
                "your licence and/or data file does not include this property"
            }
